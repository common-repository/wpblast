...
if (!class_exists('SettingsApi')) :
    class SettingsApi
    {
            ...
            foreach ($this->settings_sections as $section) {
                ...
                if (isset($section['desc']) && !empty($section['desc'])) {
                    ...
                    $callback = function () use ($section) {
                        echo wp_kses(str_replace('"', '\"', $section['desc']), $this->allowed_html);
                    };
        ...
        {
            echo wp_kses($this->get_field_description($args), $this->allowed_html);
        }
        ...
        public function callback_file($args)
        {
            ...
            $label = isset($args['options']['button_label']) ? $args['options']['button_label'] : __('Choose File', 'wpblast');
        ...
        public function callback_pages($args)
        {
            ...
            echo wp_kses(wp_dropdown_pages($dropdown_args), $this->allowed_html);
        }
